...
class Beer_Affiliate_Analytics {
    ...
    public function track_click() {
        // nonceチェック
        if (!isset($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'beer_affiliate_click')) {
    ...
    private function display_summary($start_date) {
        ...
        <div class="stats-grid">
            ...
            <div class="stat-box">
                <div class="stat-number"><?php echo number_format($unique_clicks); ?></div>
            ...
            <div class="stat-box">
                <div class="stat-number"><?php echo number_format($service_count); ?></div>
    ...
    private function display_post_stats($start_date) {
        ...
        if ($results) {
            ...
            foreach ($results as $row) {
                ...
                echo '<td>' . number_format($row->clicks) . '</td>';
                echo '<td>' . number_format($row->services) . '</td>';
                echo '<td><a href="' . get_permalink($row->post_id) . '" target="_blank">表示</a></td>';
                echo '</tr>';
            }
